...
import { ArrowRight, ArrowRightIcon, UploadCloud } from 'lucide-react'
import { useAuth } from '@clerk/nextjs';
import '@/app/css/button/uiverse.css'
import '@/app/css/button/get-started.css'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          ...
          <svg className="max-w-full" width="564" height="552" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="illustration-02" x1="-3.766" y1="300.204" x2="284.352" y2="577.921" gradientUnits="userSpaceOnUse">
                <stop stopColor="#FAEF5A" stopOpacity=".01" />
                <stop offset="1" stopColor="#FAEF5A" stopOpacity=".32" />
              </linearGradient>
            </defs>
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">Your Private Vault in the Cloud!</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Neosync.cloud offers a cutting-edge online vault designed for the secure storage of your most sensitive files.</p>
            {!isSignedIn ? (
              <div className="flex max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center gap-4 justify-center">
                <div data-aos="fade-up" data-aos-delay="400">
                  <Link className="w-full mb-4 sm:w-auto sm:mb-0" href="/sign-up">
                    <button className="shadow__btn">
                      <div className="flex justify-center text-black">
                        <span className='flex'>Get Started</span>
                        <span><ArrowRightIcon className='ml-2' />
                        </span>
                      </div>
                    </button>
                  </Link>
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                  <Link href='/dashboard' className='text-white w-full mb-4 sm:w-auto sm:mb-0'>
                    <button className="uiverse">
                      <div className="wrapper">
                        <div className="flex justify-center text-black">
                          <span>Upload</span>
                          <span><UploadCloud className='ml-2' />
                          </span>
                        </div>
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                <div data-aos="fade-up" data-aos-delay="400">
                  <Link href='/dashboard' className='flex text-white w-full mb-4 sm:w-auto sm:mb-0'>
                    <button className="uiverse">
                      <div className="wrapper">
                        <div className="flex justify-center text-black">
                          <span className='flex'>Upload</span>
                          <span><UploadCloud className='ml-2' />
                          </span>
                        </div>
                        <div className="circle circle-12"></div>
